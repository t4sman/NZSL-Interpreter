    ...
    return (
        <div id="demos" className="invisible container" ref={demosSectionRef}>
            <div style={{ position: "relative" }}>
                <video id="webcam2d" style={{ position: "absolute" }} ref={videoRef} autoPlay playsInline></video>
                <canvas className="output_canvas2d" id="output_canvas2d" ref={canvasElementRef} style={{ position: "absolute", left: "0px", top: "0px" }}></canvas>
